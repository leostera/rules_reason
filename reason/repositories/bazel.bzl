def bazel_repositories(
  ...
  native.http_archive(
      ...
      urls = [
          "http://bazel-mirror.storage.googleapis.com/github.com/bazelbuild/bazel/archive/%s.tar.gz" % bazel_version,
          "https://github.com/bazelbuild/bazel/archive/%s.tar.gz" % bazel_version,
          ],
      )
  ...
  native.http_archive(
      ...
      urls = ["https://github.com/bazelbuild/buildtools/archive/%s.zip" % buildtools_version],
      )
