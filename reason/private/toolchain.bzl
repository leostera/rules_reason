...
def reason_toolchain(name, bs_stdlib, bsc, ocaml_stdlib, ocamlc, ocamlopt,
                     ocamldep, ocamlrun, refmt, **kwargs):
    ...
    native.toolchain(
        name=name,
        toolchain_type=
        "@com_github_ostera_rules_reason//reason/toolchain:toolchain",
